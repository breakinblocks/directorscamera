...
public final class DirectorsCameraEventsGroup {
    public static final EventGroup GROUP = EventGroup.of("DirectorsCameraEvents");
    ...
    public static final EventGroup CLIENT_GROUP = EventGroup.of("DirectorsCameraClientEvents");
    ...
    private DirectorsCameraEventsGroup() {
    }
}
