package com.breakinblocks.directorscamera.config;

import net.neoforged.neoforge.common.ModConfigSpec;
import org.apache.commons.lang3.tuple.Pair;

public class DirectorsCameraConfig {
    ...
    public static class ClientConfig {
        ...
        ClientConfig(ModConfigSpec.Builder builder) {
            ...
            showSkipHint = builder
                ...
                .translation("directorscamera.configuration.showSkipHint")
                .define("showSkipHint", true);
            closeScreenOnStart = builder
                .comment("Close any open screen when a cutscene starts")
                .translation("directorscamera.configuration.closeScreenOnStart")
    ...
    public static class ServerConfig {
        ...
        ServerConfig(ModConfigSpec.Builder builder) {
            ...
            startTimeoutTicks = builder
                ...
                .translation("directorscamera.configuration.startTimeoutTicks")
