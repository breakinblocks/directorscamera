...
public record CutsceneSound(
    ...
    public static final Codec<CutsceneSound> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        Identifier.CODEC.optionalFieldOf("sound", Identifier.withDefaultNamespace("intentionally_empty")).forGetter(CutsceneSound::sound),
    ...
    public static CutsceneSound play(int tick, Identifier sound) {
    ...
    public static CutsceneSound stopEntry(int tick, String id) {
        return new CutsceneSound(tick, true, Identifier.withDefaultNamespace("intentionally_empty"), 1.0F, 1.0F, SoundSource.MASTER, Optional.empty(), false, true, id);
    }
